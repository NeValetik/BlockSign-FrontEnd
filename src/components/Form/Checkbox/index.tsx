...
const Checkbox: React.FC<React.ComponentProps<typeof CheckboxPrimitive.Root>> =({
  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        `
          peer border-input dark:bg-input/30 data-[state=checked]:bg-brand 
          data-[state=checked]:text-brand-foreground 
          dark:data-[state=checked]:bg-brand data-[state=checked]:border-brand
